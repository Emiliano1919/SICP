...
;-------Blitz-------;
(define (harmonic n) (harmonic-iter 0 1 n ))
(define (harmonic-iter a b count) (if (= count 0)
      a
      (harmonic-iter (+ a (/ 1 b)) (+ b 1) (- count 1))))

(define (Bstrategy n) (strat-iter 0 1 n ))
(define (strat-iter a b count) (if (= count 0)
      a
      (strat-iter (+ a (+ b (expt (/ (/ 1 b) (harmonic 100)) 2))) (+ b 1) (- count 1))))